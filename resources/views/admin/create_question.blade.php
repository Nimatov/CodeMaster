...
<head>
    ...
    <title>@lang('messages.admin_questions_add')</title>
        ...
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a href="{{ route('admin.questions.create') }}" class="nav-link active">
            ...
            <div class="col-md-10 main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 style="color:white;font-weight:700;">
                        <i class="fas fa-plus-circle" style="color:#00e5ff;"></i> 
                        @lang('messages.admin_questions_add')
                    </h2>
                    ...
                    <form method="POST" action="{{ route('admin.questions.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="subject" id="subject" class="form-select" required>
                                <option value="">@lang('messages.admin_questions_select_subject')</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="question" id="question" class="form-control" rows="2" placeholder="@lang('messages.admin_questions_enter_question')" required></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="option-row">
                                ...
                                <input type="text" name="option_a" class="form-control" placeholder="@lang('messages.admin_questions_option_a')" required>
                            </div>
                            <div class="option-row">
                                <span class="letter">B</span>
                                <input type="text" name="option_b" class="form-control" placeholder="@lang('messages.admin_questions_option_b')" required>
                            </div>
                            <div class="option-row">
                                <span class="letter">C</span>
                                <input type="text" name="option_c" class="form-control" placeholder="@lang('messages.admin_questions_option_c')" required>
                            </div>
                            <div class="option-row">
                                <span class="letter">D</span>
                                <input type="text" name="option_d" class="form-control" placeholder="@lang('messages.admin_questions_option_d')" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="correct" id="correct" class="form-select" required>
                                <option value="">@lang('messages.admin_questions_select_correct')</option>
